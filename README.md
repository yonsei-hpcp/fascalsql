...
This repository contains the source code for FaScalSQL, a fast and scalable GPU-accelerated analytical SQL query engine for out-of-memory tables (ICDE '26).
